...
from AmeliaRobot.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
from AmeliaRobot import dispatcher, updater, SUPPORT_CHAT
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "ᴀᴍᴇʟɪᴀ ʀᴏʙᴏᴛ ᴄʜᴀᴛʙᴏᴛ ᴅɪsᴀʙʟᴇᴅ ʙʏ {}.".format(
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "ᴀᴍᴇʟɪᴀ ʀᴏʙᴏᴛ ᴄʜᴀᴛʙᴏᴛ ᴇɴᴀʙʟᴇᴅ ʙʏ {}.".format(
                    mention_html(user.id, user.first_name)
                ),
                parse_mode=ParseMode.HTML,
            )
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        url = f"https://kukiapi.xyz/api/apikey=1891078417-KUKIiU1pIL3lX4/Amelia/Abhishek/message={anon}"
